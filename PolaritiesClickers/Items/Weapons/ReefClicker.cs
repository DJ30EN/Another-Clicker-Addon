...
namespace PolaritiesClickers.Items.Weapons
{
	...
	public class ReefClicker : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			string uniqueName = ClickerCompat.RegisterClickEffect(mod, "CoralSpikes", "Coral Spikes", "Leave 3 sticking corals for 6 seconds", 10, new Color(251, 215, 184), delegate (Player player, Microsoft.Xna.Framework.Vector2 position, int type, int damage, float knockBack)
			{
